...
function channelHasVideo(videoTitle, channel) {
  return channel.videos.some((channel) => channel.title == videoTitle);
}
...
function getChannelByVideoTitle(videoTitle, channels) {
  return channels.find((channel) =>
    channel.videos.some((channel) => channel.title == videoTitle)
  );
}
...
console.log(searchChannels("Alternate", channels));
